...
@implementation ADBrokerBase64Codec
...
-(NSString *)base64String
{
    ...
    return [ADBrokerBase64Codec base64StringFromData:utf8encoding];
}
+(NSString *)stringFromBase64String:(NSString *)base64String
{
    NSData *utf8encoding = [ADBrokerBase64Codec dataFromBase64String:base64String];
...
{
    return [ADBrokerBase64Codec dataFromBase64String:base64String];
}
-(NSString *)base64String
{
    return [ADBrokerBase64Codec base64StringFromData:self];
}
@end
