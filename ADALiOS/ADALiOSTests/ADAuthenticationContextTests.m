...
-(void) testBadAuthorityWithValidation
{
    ...
    ADTestURLResponse* response = [ADTestURLResponse requestURLString:@"https://login.windows.net/common/discovery/instance?api-version=1.0&authorization_endpoint=https://myfakeauthority.microsoft.com/msopentechbv.onmicrosoft.com/oauth2/authorize&x-client-Ver=" ADA_NETWORKL_VERSION_STRING
...
- (void)testBadRefreshToken
{
    ...
    ADTestURLResponse* response = [ADTestURLResponse requestURLString:@"https://login.windows.net/msopentechbv.onmicrosoft.com/oauth2/v2.0/token?x-client-Ver=" ADA_NETWORKL_VERSION_STRING
                                                            responseURLString:@"https://login.windows.net/msopentechbv.onmicrosoft.com/oauth2/v2.0/token?x-client-Ver=" ADA_NETWORKL_VERSION_STRING
                                                                 responseCode:400
...
- (void)testUnreachableAuthority
{
    ...
    [ADTestURLConnection addNotFoundResponseForURLString:@"https://somevalidurlbutnonexistentdomain.com/sometenant.com/oauth2/v2.0/token?x-client-Ver=" ADA_NETWORKL_VERSION_STRING];
