...
- (void) testParametersFromResourceURLNoResponse
{
    ...
    [ADTestURLConnection addNotFoundResponseForURLString:@"https://noneistingurl12345676789.com?x-client-Ver=" ADA_NETWORKL_VERSION_STRING];
...
- (void) testParametersFromResourceURLParametersPositiveCase
{
    ...
    ADTestURLResponse* response = [ADTestURLResponse requestURLString:@"http://testapi007.azurewebsites.net/api/WorkItem?x-client-Ver=" ADA_NETWORKL_VERSION_STRING
