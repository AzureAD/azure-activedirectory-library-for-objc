...
- (RegistrationInformation*)getRegistrationInformation: (NSString*) sharedAccessGroup
                                                 error: (NSError**) error
{
    AD_LOG_VERBOSE(@"Attempting to get registration information from %@ shared access keychain",
                            sharedAccessGroup);
                             ...
                             certificate: (SecCertificateRef*) clientCertificate
{
    ...
    [identityAttr setObject:(id)kCFBooleanTrue forKey:(id<NSCopying>)(kSecReturnRef)];
    [identityAttr setObject:(id) kSecAttrKeyClassPrivate forKey:(id)kSecAttrKeyClass];
#endif
