...
@class ADTestInstance;

@interface ADTestMainViewController : UIViewController <BVTestFlipsideViewControllerDelegate, UIPopoverControllerDelegate>
{
    ...
    @protected
    ADTestAppSettings* mTestData;
    ADTestInstance* mAADInstance;
}
